#!/usr/bin/env python3
"""
4H Band Cross Detector - TRUE CROSSOVER DETECTION
...
class BandDetector4H:
    def __init__(self, state_file: str = 'cache/gc_4h_state.json'):
        ...
        if last_band is None:
            if hband_crossover:
                alert = self._create_alert(symbol, 'HBAND', cross_method_h, 'BULLISH',
                                          ...
                                          filter_line, upper_band, lower_band, timestamp)
    ...
    def _create_alert(self, symbol, band, cross_method, direction,
        ...
        return {
            ...
            'direction': direction,
            'alert_message': f"{symbol} crossed {band_name} ({cross_method}) on 4H"
        }
